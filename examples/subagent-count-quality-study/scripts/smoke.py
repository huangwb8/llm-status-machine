...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run one simulator episode for this instance.")
    ...
    prompt = (ROOT / "prompts/prompt-3.md").read_text(encoding="utf-8")
    spec = StudySpec(
        name="subagent-count-quality-smoke",
        repeats=1,
        prompts=[PromptRevision(id="evaluators-3", body=prompt)],
